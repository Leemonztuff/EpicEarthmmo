...
import { Modal, IconBox, Text, Button, Badge, ProgressBar } from '@/components/ui';
import { Check, Lock, Zap, Star, Sparkles, BookOpen, Info } from 'lucide-react';
              ...
              >
                <div className="flex items-start justify-between">
                  <div className={cn(
                    ...
                    {isUnlocked ? <Check size={20} /> : meetsReqs ? <BookOpen size={20} /> : <Lock size={18} />}
                  </div>
                  {skill.spCost > 0 && (
            ...
            >
              <div className="flex flex-col gap-4">
                <div className="flex items-start justify-between">
                  ...
                  <div className="w-14 h-14 rounded-3xl bg-slate-900 border border-white/5 flex items-center justify-center">
