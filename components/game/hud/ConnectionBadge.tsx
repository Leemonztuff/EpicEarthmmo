...
export function ConnectionBadge() {
  ...
  return (
    ...
    >
      <span className={`w-1.5 h-1.5 rounded-full ${connected ? 'bg-green-400 shadow-[0_0_6px_rgba(74,222,128,0.6)]' : 'bg-amber-400 shadow-[0_0_6px_rgba(251,191,36,0.6)]'}`} />
      <span className="text-[10px] font-medium text-slate-400 truncate max-w-[140px]">
        {connected ? serverUrl : 'Offline — datos locales'}
      </span>
    </motion.div>
  );
}
